      ...
      <div className="flex flex-1 bg-newBgColorInner rounded-[20px] flex-col relative">
        ...
        <div className="flex-1 flex p-[40px]">
          <div className="flex flex-col gap-[24px] flex-1">
            {/*
              Az upstream itt egy masodik lepest tett: "Watch Tutorial", ami a
              Postiz sajat YouTube-videojat agyazta be. Egy Postora nevu
              alkalmazasban egy masik termek oktatovideoja a felhasznalonak
              zavaro, egy app-review birallonak pedig ellentmondas. Amig sajat
              bemutato videonk nincs, a bevezetes egy lepes: kosd be a
              csatornaidat.
            */}
