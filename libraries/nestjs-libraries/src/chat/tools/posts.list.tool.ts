...
Posts cannot be deleted through the Postora tools - if the user wants to delete a post, tell them to do it themselves in the Postora app; never offer to delete a post.
`,
